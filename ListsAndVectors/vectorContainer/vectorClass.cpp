...
//vector container in C++, as well as its functions.
//=====================================================

//Include STL Library & IO:
#include <iostream>
#include <vector>
#include <algorithm>
...
using namespace std;
//Created printVector() function to display
//the contents of the vector more clearly.
template<class T>
void printVector(char const *s, const vector<T>& v) {
    cout << s << " = (";
    if (v.size() == 0) {
        cout << ")\n";
        return;
